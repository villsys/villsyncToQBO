...
export async function pushShopifyExpenses(data, config, context) {
    ...
    data.forEach(t => {
        ...
        const groupKey = t.settlementId || t.dateTime; // Group fees by Payout ID
    ...
    let txnsPushed = 0;
    let linesPushed = 0;
    const typeName = "shopify fee/expense";
    ...
    for (const [groupKey, groupData] of Object.entries(groups)) {
        ...
        const signature = `SHP_EXP_${exactTimeMs}_${groupData.settlementId}_${netAmount.toFixed(2)}`;
        ...
        const payload = {
            ...
            "data": {
                ...
                "PrivateNote": `Shopify Fees for Payout ID: ${groupData.settlementId}`,
                "Line": qboLines
            }
        };
